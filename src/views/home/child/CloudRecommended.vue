    ...
    <div>
        <div class="w-[100vw] px-[4vw] dark:text-[#e9ebf2]">
            <div class="flex justify-between items-center h-[12vw]">
                <div class="flex items-center"><span
                        class="dark:text-[#e9ebf2] text-[#374d5b] text-[4vw] font-[800]">推荐歌单</span> <svg
            ...
            <van-popup v-model="show" round position="bottom" :style="{ height: '22%' }">
                <div class="dark:bg-[#272727] bg-[#fff] fixed z-[11]"
                    ...
                    <div>
                        <div
                            ...
                            <p class="text-[3vw] text-[#939BA1] font-[800]">推荐歌单</p> <svg @click="show = false"
        ...
        <div class="w-[98vw] h-[46vw] pt-[1vw] overflow-hidden scroll-wrapper border-[#EBEDF2]" ref="scroll">
            ...
            <div class="w-[210vw] flex pl-[2vw]">
                <van-swipe class="my-swipe w-[31vw] h-[36vw] mr-[3vw] pt-[1vw]" :touchable="false" :show-indicators="false" :autoplay="3000" indicator-color="white" vertical>
                    <van-swipe-item v-for="item,index in resTo" :key="index">
                        <div class="w-[31vw] relative z-[1]">
                            <div
                                class="dark:bg-[#1A1C23] w-[31vw] h-[31vw] bg-[#f3f3f3] overflow-hidden relative rounded-[8px]">
                                <svg style="z-index: 99;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" class="absolute text-[#fff] w-[10vw] h-[6vw] right-0 iconify iconify--iconoir"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m14 9l-.25.375M10 9a5 5 0 1 0 0 6l.334-.5M10 9l4 6a5 5 0 1 0 0-6"></path></svg>
                                <div class="absolute top-0 left-0&quot;"><img :src="item.uiElement.image.imageUrl" alt=""
                                        class="w-[31vw] h-[31vw] rounded-[8px]"></div><!----><!---->
                            ...
                            <p class="dark:text-[#e3e5ec] text-[2.78vw] text-[#3E4759] scroll-item" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">{{ item.uiElement.mainTitle.title }}</p>
                        </div>
                        <div class="dark:bg-[#272727] w-[26vw] h-[31vw] bg-[#ddd] absolute top-[-1vw] left-1/2 -translate-x-1/2 rounded-[8px] z-[0]"></div>
                    </van-swipe-item>
                </van-swipe>
                <div class="pt-[1vw] relative mr-[3vw]" style="pointer-events: auto ;" v-for="item in res"
                    :key="item.creativeId">
...
export default {
    name: 'WorkspaceJsonCloudRecommended',
    ...
    async created() {
        ...
        if (!err) {
            this.resTo = res.data.data.blocks[2].creatives[0].resources;
            this.res = res.data.data.blocks[2].creatives.slice(1);
        }
    },
    mounted() {
        this.init()
